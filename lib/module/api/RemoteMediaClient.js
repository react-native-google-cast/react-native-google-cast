...
import { MediaPlayerIdleReason, MediaPlayerState } from 'react-native-google-cast';
const {
...
export default class RemoteMediaClient {
  ...
  onMediaPlaybackEnded(handler) {
    ...
    return this.onMediaStatusUpdated(mediaStatus => {
      ...
      if ((mediaStatus === null || mediaStatus === void 0 ? void 0 : mediaStatus.idleReason) !== MediaPlayerIdleReason.FINISHED) return;
      playbackEnded = true;
      handler(mediaStatus);
    });
  }
  ...
  onMediaPlaybackStarted(handler) {
    ...
    return this.onMediaStatusUpdated(mediaStatus => {
      ...
      if ((mediaStatus === null || mediaStatus === void 0 ? void 0 : mediaStatus.playerState) !== MediaPlayerState.PLAYING) return;
