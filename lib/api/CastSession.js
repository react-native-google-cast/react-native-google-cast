 ...
 * @export
 * @class CastSession
 * @see [Android]{@link https://developers.google.com/android/reference/com/google/android/gms/cast/framework/CastSession}
 * @see [iOS]{@link https://developers.google.com/cast/docs/reference/ios/interface_g_c_k_cast_session}
 * @see [Chrome]{@link https://developers.google.com/cast/docs/reference/chrome/cast.framework.CastSession}
 */
export default class CastSession {
   ...
   *
   * @param {boolean} mute The new mute state.
   * @memberof CastSession
   ...
   *
   * @param {number} volume If volume is outside of the range [0.0, 1.0], then the value will be clipped.
   * @memberof CastSession
