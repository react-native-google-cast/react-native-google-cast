...
public final class Func_void_CastState {
  ...
  /**
   * Casts an unsafe pointer to a `Func_void_CastState`.
   * The pointer has to be a retained opaque `Unmanaged<Func_void_CastState>`.
   * This removes one strong reference from the object!
   */
  @inline(__always)
  public static func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> Func_void_CastState {
    return Unmanaged<Func_void_CastState>.fromOpaque(pointer).takeRetainedValue()
  }
}
