...
namespace margelo::nitro::googlecast {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/googlecast/Func_void_CastState;";
  ...
  /**
   * An implementation of Func_void_CastState that is backed by a C++ implementation (using `std::function<...>`)
   */
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/googlecast/Func_void_CastState_cxx;";
    static void registerNatives() {
      registerHybrid({makeNativeMethod("invoke_cxx", JFunc_void_CastState_cxx::invoke_cxx)});
    }
