...
namespace margelo::nitro::googlecast {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/googlecast/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/googlecast/Func_void_cxx;";
